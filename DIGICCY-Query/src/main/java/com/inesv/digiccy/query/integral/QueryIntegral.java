...
public class QueryIntegral {
	 ...
	 * @return
	 */
	public List<IntegralCompleteDto> queryIntegralComplete(IntegralCompleteDto completeDto,
		...
		try {
			...
			// 分页
			int count = queryRunner
					.query(sql, new BeanListHandler<>(IntegralCompleteDto.class), paramArr.toArray(new Object[] {}))
					.size();
			...
			dtosList = queryRunner.query(sql, new BeanListHandler<>(IntegralCompleteDto.class),
	...
	public List<IntegralDetailDto> queryIntegralDetail(IntegralDetailDto detailDto, PaginationDto paginationDto) {
		...
		try {
			...
			if (R.isNull(detailDto.getUserId())) {
				sql += " and de.user_id=?";
				paramArr.add(detailDto.getUserId());
			}

			// 分页
			int count = queryRunner
					.query(sql, new BeanListHandler<>(IntegralDetailDto.class), paramArr.toArray(new Object[] {}))
					.size();
			paginationDto.setTotalCount(count);
			paginationDto.setTotalPageNum(count / paginationDto.getPerPageSize());
			...
			System.out.println("**************sql**********: " + sql);
			detailDtos = queryRunner.query(sql, new BeanListHandler<>(IntegralDetailDto.class),
					paramArr.toArray(new Object[] {}));
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public List<IntegralGradeDto> queryIntegralGrade(IntegralGradeDto gradeDto, PaginationDto paginationDto) {
		...
		try {
			...
			// 分页
			int count = queryRunner
					.query(sql, new BeanListHandler<>(IntegralGradeDto.class), paramArr.toArray(new Object[] {}))
					.size();
			paginationDto.setTotalCount(count);
			paginationDto.setTotalPageNum(count / paginationDto.getPerPageSize());
			...
			System.out.println("**************sql**********: " + sql);
			gradeDtos = queryRunner.query(sql, new BeanListHandler<>(IntegralGradeDto.class),
					paramArr.toArray(new Object[] {}));
	...
	public List<IntegralRuleDto> queryIntegralRule(IntegralRuleDto integralRuleDto, PaginationDto paginationDto) {
		...
		try {
			...
			// 分页
			int count = queryRunner
					.query(sql, new BeanListHandler<>(IntegralRuleDto.class), paramArr.toArray(new Object[] {})).size();
			paginationDto.setTotalCount(count);
			paginationDto.setTotalPageNum(count / paginationDto.getPerPageSize());
			...
			System.out.println("**************sql**********: " + sql);
			gradeDtos = queryRunner.query(sql, new BeanListHandler<>(IntegralRuleDto.class),
					paramArr.toArray(new Object[] {}));
	...
	public List<CompletionDto> queryCompletion(String id) {
		...
		try {
			...
			System.out.println("**************sql**********: " + sql);
			completions = queryRunner.query(sql, new BeanListHandler<>(CompletionDto.class),
					paramArr.toArray(new Object[] {}));
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public List<UserImgDto> queryImgUri(UserImgDto imgDto, PaginationDto paginationDto) {
		...
		try {
			...
			// 分页
			int count = queryRunner
					.query(sql, new BeanListHandler<>(UserImgDto.class), paramArr.toArray(new Object[] {})).size();
			paginationDto.setTotalCount(count);
			paginationDto.setTotalPageNum(count / paginationDto.getPerPageSize());
			...
			System.out.println("**************sql**********: " + sql);
			imgDtos = queryRunner.query(sql, new BeanListHandler<>(UserImgDto.class),
					paramArr.toArray(new Object[] {}));
		} catch (Exception e) {
			e.printStackTrace();
		}
