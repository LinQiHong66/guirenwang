...
public class QueryPoundatge {
	...
	public long getSize(String userOrgCode, String phone, String username, String startDate, String endDate) {
		...
		String sql = "select count(*) as count from t_inesv_poundage as p where user_no in (select user_no from t_inesv_user where 1=1 "
				+ userWhere + ") " + pounWhere + " order by date desc";
		try {
