...
public class SendMsgUtil implements ApplicationContextAware {
    ...
    /* private Map<String, Object> sendMsg(String mobile, int type) {
     * Map<String, Object> result = new HashMap<String, Object>();
     * TaobaoClient client = new DefaultTaobaoClient(SmsConstant.MESSAGE_url, SmsConstant.MESSAGE_appkey, SmsConstant.MESSAGE_secret);
     * AlibabaAliqinFcSmsNumSendRequest req = new AlibabaAliqinFcSmsNumSendRequest();
     * req.setSmsType("normal");// 必须 短信类型
     * req.setSmsFreeSignName("bg系统");// 签名
     * // 参数内容
     * Map<String, Object> param = new HashMap<String, Object>();
     * Integer code;
     * code = getCode(mobile, type);
     * param.put("number", code + "");
     * // 参数只接受string
     * req.setSmsParamString(JSON.toJSONString(param));
     * req.setRecNum(mobile);// 短信接收者
     * req.setSmsTemplateCode(getSmsTemplateCode(type));// 短信模板id
     * try {
     * AlibabaAliqinFcSmsNumSendResponse rsp = client.execute(req);//发送手机短信
     * // 存入缓存
