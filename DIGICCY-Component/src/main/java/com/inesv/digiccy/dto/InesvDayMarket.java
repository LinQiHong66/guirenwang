...
public class InesvDayMarket {
    ...
    public InesvDayMarket(long id, Integer coin_type, BigDecimal newes_deal,
			...
			Date date, String attr1, String attr2) {
		this.id = id;
    ...
    public void setNewes_deal(BigDecimal newes_deal) {
        this.newes_deal = newes_deal;
    }
    ...
    public void setDay_percent(BigDecimal day_percent) {
        this.day_percent = day_percent;
    }
	...
	public String toString() {
		return "InesvDayMarket [id=" + id + ", coin_type=" + coin_type
				+ ", newes_deal=" + newes_deal + ", buy_price=" + buy_price
				+ ", sell_price=" + sell_price + ", deal_num=" + deal_num
				+ ", deal_price=" + deal_price + ", day_percent=" + day_percent
				+ ", max_price=" + max_price + ", min_price=" + min_price
				+ ", state=" + state + ", date=" + date + ", attr1=" + attr1
				+ ", attr2=" + attr2 + "]";
	}

	public InesvDayMarket() {
	}
}
