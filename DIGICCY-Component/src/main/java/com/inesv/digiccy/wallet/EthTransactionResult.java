...
public class EthTransactionResult {
	...
	private static Logger logger = LoggerFactory.getLogger(EthTransactionResult.class);


	public EthTransactionResult(String url, String port, String username,String password, String walletpaps) {
		super();
		this.url = url;
		this.port = port;
