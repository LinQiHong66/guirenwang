...
public class CoinCommand {
    ...
    public CoinCommand(Long coinId, Integer coinNo, String coinName, String coinCore, Integer vote, Integer state,
    ...
    public CoinCommand(Long coinId, Integer coinNo, String coinName, String coinCore, Integer state,
                       Date date, String attr1, String attr2, String operation, Integer vote) {
        this.coinId = coinId;
        this.coinNo = coinNo;
        this.coinName = coinName;
        this.coinCore = coinCore;
