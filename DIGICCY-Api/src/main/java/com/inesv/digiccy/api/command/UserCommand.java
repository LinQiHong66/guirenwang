...
public class UserCommand {
    ...
    public UserCommand(long id, String username, int user_no, String password, String real_name, String mail, String phone,
    ...
    public UserCommand(long id, String username, String deal_pwd, String operation) {
        this.id = id;
        this.username = username;
        this.deal_pwd = deal_pwd;
        this.operation = operation;
     ...
     * 测试
     */
    public UserCommand(int user_no,String operation) {
    	this.user_no = user_no;
    	this.operation=operation;
    }
