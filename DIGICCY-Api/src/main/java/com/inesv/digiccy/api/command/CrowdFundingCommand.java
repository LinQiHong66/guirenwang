 ...
 */
public class CrowdFundingCommand {
	...
	public CrowdFundingCommand(Long id, String ico_no, String ico_name, String ico_photo, Integer ico_target,
	...
	public String toString() {
		return "CrowdFundingCommand [id=" + id + ", ico_no=" + ico_no + ", ico_name=" + ico_name + ", ico_photo="
				+ ico_photo + ", ico_target=" + ico_target + ", ico_current=" + ico_current + ", ico_status="
				+ ico_status + ", ico_price_type=" + ico_price_type + ", ico_price=" + ico_price + ", ico_sum_price="
				+ ico_sum_price + ", ico_remark=" + ico_remark + ", ico_explain=" + ico_explain + ", ico_state="
				+ ico_state + ", begin_date=" + begin_date + ", end_date=" + end_date + ", attr1=" + attr1 + ", attr2="
				+ attr2 + ", attr3=" + attr3 + ", attr4=" + attr4 + ", attr5=" + attr5 + ", attr6=" + attr6
				+ ", operation=" + operation + "]";
	}
