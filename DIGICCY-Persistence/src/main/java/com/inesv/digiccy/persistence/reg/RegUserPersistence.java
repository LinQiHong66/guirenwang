...
public class RegUserPersistence {
    ...
    public synchronized void addUser(InesvUserDto inesvUserDto,String recCode,String inviteNum) throws Exception {
    	//新增用户信息表
        ...
        Object params[] = {inesvUserDto.getUsername(),inesvUserDto.getPassword(),inesvUserDto.getReal_name(),inesvUserDto.getPhone(),inesvUserDto.getState(),
                inesvUserDto.getInvite_num(),inesvUserDto.getDate(),1,inesvUserDto.getOrg_type(),inesvUserDto.getOrg_code(),inesvUserDto.getOrg_parent_code()};
        ...
        if(!"".equals(inviteNum) && inviteNum != null){
            ...
            Object parmas1[]={inviteNum};
            	UserInfoDto userInfoDto1 = (UserInfoDto) queryRunner.query(userInfoSql1,new BeanHandler(UserInfoDto.class),parmas1);
            ...
            if(userInfoDto1 != null){
                ...
                Object parmas2[]={inesvUserDto.getPhone()};
                	UserInfoDto userInfoDto2 = (UserInfoDto) queryRunner.query(userInfoSql2,new BeanHandler(UserInfoDto.class),parmas2);
    ...
    public void addUser(InesvUserDto inesvUserDto) throws Exception {
        String sql = "insert into t_inesv_user(username,password,region,real_name,certificate_num,deal_pwd,mail,phone,state,invite_num,date,phone_state,org_type,org_code,org_parent_code) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        Map<Long, Map<String, Object>> key = null;
    ...
    public void updateParentCode(InesvUserDto inesvUserDto) throws Exception{
    	...
    	if(!StringUtils.isBlank(inesvUserDto.getInvite_num()) && !StringUtils.isBlank(inesvUserDto.getOrg_code())) {
        	...
        	params = new String[]{inesvUserDto.getInvite_num(),inesvUserDto.getOrg_code(),inesvUserDto.getOrg_parent_code(),inesvUserDto.getUser_no()+""};
    	}
    	if(!StringUtils.isBlank(inesvUserDto.getInvite_num()) && StringUtils.isBlank(inesvUserDto.getOrg_code())){
    		sql = "update t_inesv_user set invite_num = ? , org_parent_code = ? where user_no = ? ";
        	params = new String[]{inesvUserDto.getInvite_num(),inesvUserDto.getOrg_parent_code(),inesvUserDto.getUser_no()+""};
    	}
    	if(StringUtils.isBlank(inesvUserDto.getInvite_num()) && !StringUtils.isBlank(inesvUserDto.getOrg_code())){
    		sql = "update t_inesv_user set org_code = ? , org_parent_code = ? where user_no = ? ";
        	params = new String[]{inesvUserDto.getOrg_code(),inesvUserDto.getOrg_parent_code(),inesvUserDto.getUser_no()+""};
    	}
    	try {
			queryRunner.update(sql, params);
		} catch (SQLException e) {
