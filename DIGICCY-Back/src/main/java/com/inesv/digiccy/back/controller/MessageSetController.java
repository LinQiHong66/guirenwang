...
public class MessageSetController {
	...
	@ResponseBody
	public Map<String, Object> modifyMessageSet(int id, int limit_date,
			int limit_number, String limit_ip, String limit_name) {
		System.out.println("id:" + id + ",limit_date:" + limit_date
				+ ",limit_number：" + limit_number + ",limit_ip：" + limit_ip
				+ ",limit_name:" + limit_name);
		return messageSetValidate.modifyMessageSet(id, limit_date,
				limit_number, limit_ip, limit_name);
	}
