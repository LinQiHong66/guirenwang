            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">批量入金</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>批量入金</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body" align="center" align="center">
                          	<a href="/file/getFile.do?fileType=balanceTemplate">获取批量入金模板</a>
                          	<!-- 批量处理表单 -->
                          	<form id="balanceform" method="post" enctype="multipart/form-data">
								<input type="file" name="excelFile" onchange="changeExcel()" /><br />
								<input type="hidden" name="fileType" value="balanceTemplate" />
								<div hidden="true">
								<input id="check_cb" type="checkbox" disabled="disabled" name="addAddress" />是否添加用户地址
								</div>
							</form>
							<span id="executeInfo"></span><br />
							<button onclick="checkExcel()">检验表单</button>
							
							<div id="bachBalance" style="display: none">
								<button id="executeGload" disabled="disabled" onclick="startBalance()">开始入金</button>
								<button onclick="showResult()">查看结果</button><a href="/file/getResultExcel.do?fileType=balanceTemplate">导出结果</a><br />
								
								注：<br />
								查看到的结果是点击按钮时刻的结果，可能不是最终结果！
								<span id="balanceResult">
								</span>
							</div>
...
<script src="/app/js/ajax/balanceFile.js"></script>
