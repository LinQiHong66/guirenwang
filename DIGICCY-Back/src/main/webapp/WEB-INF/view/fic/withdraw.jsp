            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">虚拟币提现</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>虚拟币提现</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            ...
                            <form action="/fic/excelWithdraw.do" method="POST">
                            	<div>
                            ...
                            <!-- 	 货币类型：<select name='coinTypeSearch' id="coinTypes" style="width:13%;"></select> -->
                            	...
                            	<input type="button" onclick="getWithdrawdatas();" value='查询' /><input type="submit" value="导出Excel" />
                            </form>
...
<script src="/app/js/bootstrap-table/fic-tab.js"></script>
