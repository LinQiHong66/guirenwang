            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">修改认购项目</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <!-- BEGIN PAGE CONTENT-->
                        ...
                        <div class="widget-body">
                            ...
                            <form class="form-inline">
                                ...
                                <div class="form-group" style="margin-top: 5px">
                                    ...
                                    <input type="text"id="price" class="form-control" style="border-radius: 5px">
                                </div>
                                <div class="form-group" style="margin-top: 5px">
                                ...
                                <div class="form-group" style="margin-top: 5px">
                                    ...
                                    <input type="text" id="limit" class="form-control" style="border-radius: 5px">
                                </div>
                                <div class="form-group" style="margin-top: 5px">
                                    <label class="form-label">解冻次数:</label>&nbsp;&nbsp;
                                    <input type="text" id="thaw" class="form-control" style="border-radius: 5px">
                                </div>
                                <div class="form-group" style="margin-top: 5px">
                                    <label class="form-label">解冻周期:</label>&nbsp;&nbsp;
                                    <input type="text" id="cycle" class="form-control" style="border-radius: 5px">
                                </div>
                                <div class="form-group" style="margin-top: 5px">
                                    <label class="form-label">是否启用:</label>&nbsp;&nbsp;
                                    <label class="radio">
                                        <input type="radio" name="sub_status" value="1" id="yes"/>
                                        是
                                    </label>
                                    <label class="radio">
                                        <input type="radio" name="sub_status" value="0" id="no" checked/>
                                        否
                                    </label>
                                    <%--<input type="text" name="role.description" id="role_desc" class="form-control" style="border-radius: 5px">--%>
                                </div>
                                <div class="form-group" style="margin-top: 5px">
                                    <button type="button" class="btn blue" id="add_Role" onclick="update()"><i class="icon-ok"></i>保存</button>
...
<script src="/app/js/ajax/subCore_update.js"></script>
