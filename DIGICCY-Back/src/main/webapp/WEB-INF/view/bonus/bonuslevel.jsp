...
<link href="/app/assets/bootstrap-table/bootstrap-table.css"
	rel="stylesheet" />
<link href="/app/assets/bootstrap/css/bootstrap-fileupload.css"
	rel="stylesheet" />
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="#">分润记录</a><span class="divider-last">&nbsp;</span></li>
						</ul>
					</div>
				</div>
				<!-- BEGIN PAGE CONTENT-->
						...
						<div class="widget">
							...
							<div class="widget-body">
								<form action="/bonuslevel/getExcel.do" method="POST">
									查询条件：<br /> 用户编号：<input type="text" id='userCode'
										name='userCode' />手机号：<input type="text" id="userPhone"
										name="userPhone" />姓名：<input id="userName" name="userName"
										type="text" />分润日期：<input type="date" id="startDate"
										name="startDate" />-<input type="date" id="endDate"
										name="endDate" /> <br /> <input type="submit"
										value="导出Excel" />
								</form>

								<button onclick='selectBonus()'>查询</button>
								<br />
