            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">口令红包用户获取列表</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>口令红包用户获取列表</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                           	<!-- <a href="/commandRed/gotoAdd.do"><button class="btn btn-success" id="btn_add"><i class="icon-plus icon-white"></i>&nbsp;新增</button></a> -->
                            ...
                            <table id="commandRedDetail_table">
...
<script src="/app/js/bootstrap-table/commandRedDetail-tab.js"></script>
