            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">口令红包列表</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>口令红包列表</h4>
                            <span class="tools">
                                        <a href="javascript:;" class="icon-chevron-down"></a>
                                        <a href="javascript:;" class="icon-remove"></a>
                            </span>
                        </div>
                        <input type="hidden" name="commandNo" id="commandNo" value="${command_no}"/>
                        <div class="widget-body">
                        	<a href="/commandRed/outputCommandRed.do?command_no=${command_no}"><button class="btn btn-success" id="btn_add"><i class="icon-plus icon-white"></i>&nbsp;导出Excel</button></a>
                            <table id="commandRedInfo_table">
...
<script src="/app/js/bootstrap-table/commandRed-tab.js"></script>
