            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">修改口令红包项目</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>修改口令红包项目</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            ...
                            <%--<button class="btn btn-primary" id="btn_delete"><i class="icon-remove icon-white"></i>&nbsp;删除</button>--%>
                                <div class="form-group" style="margin-top: 5px">
                                    ...
                                    <input type="hidden" name="command_no" id="command_no" class="form-control" style="border-radius: 5px" value="${commandRed.data.command_no}">
                                    <input type="text" name="command_name" id="command_name" class="form-control" style="border-radius: 5px" value="${commandRed.data.command_name}">
                                </div>
                                <div class="form-group" style="margin-top: 5px">
                                    ...
                                    <select  class="input-large m-wrap" tabindex="1" id="command_prize_type" name="command_prize_type">
										...
										<%-- <c:if test="${commandRed.data.command_prize_type==0}">
											<option value="0" selected="selected">人民币</option>
                                    		<option value="1">奖品</option>
										</c:if>
										<c:if test="${commandRed.data.command_prize_type==1}">
                                ...
                                <div class="form-group" style="margin-top: 5px">
                                    ...
                                    <input type="text" id="command_name_price" name="command_name_price" onblur="isNumber(this)" class="form-control" style="border-radius: 5px" value="${commandRed.data.command_name_price}">
                                </div>
                                <div class="form-group" style="margin-top: 5px">
                            ...
                            <div class="form-group" style="margin-top: 5px">
                                <button id="editCommandRed"  class="btn">修改</button>
...
<script src="/app/js/ajax/commandRed_edit.js"></script>
...
commandRemark.$txt.append('${commandRed.data.command_remark}')
</script>
<script type="text/javascript">
//判断是否数字
function isNumber(v) {
