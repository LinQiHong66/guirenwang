                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>新增公告</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body form">
                            ...
                            <form action="#" class="form-horizontal">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="hidden" id="notice_id" class="form-control" value="${data.id}">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="hidden"  id="notice_type" class="form-control" value="${data.notice_type}">
                                        <select  class="input-large m-wrap"  id="type">
                                        	<c:if test="${data.notice_type==1}">
                                        		<option value="1" selected>公告</option>
                                            	<option value="2">新闻</option>
                                            	<option value="3">常见问题</option>
                                            	<option value="4">其他</option>
                                        	</c:if>
                                            <c:if test="${data.notice_type==2}">
                                        		<option value="1">公告</option>
                                            	<option value="2" selected>新闻</option>
                                            	<option value="3">常见问题</option>
                                            	<option value="4">其他</option>
                                        	</c:if>
                                        	
                                            <c:if test="${data.notice_type==3}">
                                        		<option value="1">公告</option>
                                            	<option value="2" >新闻</option>
                                            	<option value="3" selected>常见问题</option>
                                            	<option value="4">其他</option>
                                        	</c:if>
                                        	
                                            <c:if test="${data.notice_type==4}">
                                        		<option value="1">公告</option>
                                            	<option value="2" >新闻</option>
                                            	<option value="3" >常见问题</option>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea id="editor" placeholder="这里输入内容" style="height: 200px"></textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <button type="button" class="btn blue" onclick="updateNotice()"><i class="icon-ok"></i>保存</button>
                                    <a href="/notice/gotoNotice.do"><button type="button" class="btn blue"><i class="icon-share-alt"></i>返回</button></a>
...
<script>
    ...
    editor.create();
    editor.$txt.append('${data.context}')

    /* $("#type option[value='1']").attr("selected","selected");
    $("#type option[value='1']").removeAttr("selected");
    $("#type option[value='"+$('#notice_type')+"']").attr("selected","selected"); */
    $(function(){
					...
					if (result != 'none') {
						...
						$
								.each(
										result,
										function(a, b) {
											sav = ${data.notice_nametype}
											s+='<option value="'+b.id+'" '+(sav==b.id?'selected':'')+'>'+b.name+'</option>';
										});
						nameType.html(s);
					}
				}
