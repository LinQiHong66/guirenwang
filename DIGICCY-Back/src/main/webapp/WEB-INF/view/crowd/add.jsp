                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            ...
                            <form id="myform"  enctype="multipart/form-data" method="POST" class="form-inline">
                                ...
                                <div class="form-group" style="margin-top: 5px">
                                    <label class="form-label">支付货种:</label>&nbsp;&nbsp;
                                ...
                                <div class="form-group" style="margin-top: 5px">
                                    ...
                                    <input type="text" id="minNumber" name="minNumber" class="form-control" style="border-radius: 5px">
                                </div>
                                <div class="form-group" style="margin-top: 5px">
                                    <label class="form-label">最高限购份数:</label>&nbsp;&nbsp;
                                    <input type="text" id="maxNumber" name="maxNumber" class="form-control" style="border-radius: 5px">
                                </div>
                                <div class="form-group" style="margin-top: 5px">
                                    <label class="form-label">最低份数整数倍:</label>&nbsp;&nbsp;
                                ...
                                <div class="form-group" style="margin-top: 5px">
                                    ...
                                    <input type="text" id="convert" name="convert" class="form-control" style="border-radius: 5px">
                                </div>
                                <div class="form-group" style="margin-top: 5px">
