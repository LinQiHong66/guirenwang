            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="#">ICO众筹管理</a> <span class="divider">&nbsp;</span>
                        </li>
                        <li>
                        	<a href="#">用户众筹列表</a><span class="divider-last">&nbsp;</span>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>用户众筹列表</h4>
                            <span class="tools">
                        ...
                        <a href="/crowFundingDetail/excelDetail.do"><button class="btn btn-success" id="btn_add"><i class="icon-plus icon-white"></i>&nbsp;导出Excel</button></a>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <div class="span12">
                                    ...
                                    <div class="tabbable tabbable-custom">
                                        <ul class="nav nav-tabs">
                                           <li class="active"><a href="#tab_1_1" onclick="initDetailTab()" data-toggle="tab">众筹详情记录</a></li>
                                            <li><a href="#tab_1_2" id="aaa"  data-toggle="tab">机构TOP-50</a></li>
                                            <li><a href="#tab_1_3" id="bbb"  data-toggle="tab">用户TOP-50</a></li>
                                            <li>
                                            	<a href="#tab_1_4" id="ccc"  data-toggle="tab">机构会员众筹信息</a>
                                            	<select  class="input-large m-wrap" tabindex="1" id="orgCode" name="orgCode">
