...
<body class="fixed-top">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="#">首页轮播图</a><span class="divider-last">&nbsp;</span></li>
						</ul>
					</div>
				</div>
				<!-- BEGIN PAGE CONTENT-->
					...
					<div class="span12 sortable">
						...
						<div class="widget">
							...
							<div id="addmodal" class="modal hide fade in"
								...
								<form action="/other/addHomeImg.do"
									...
									<div class="modal-body">
										<input type='file' name="imgFile" /><br /> <input
											type="text" hidden="图片描述" name="imgInfo" /><br />
									</div>
							...
							<div id="modifymodal" class="modal hide fade in"
								...
								<form action="/other/modifyhomeimg.do"
									enctype="multipart/form-data" method="POST">
									<div class="modal-header">
										<a class="close" data-dismiss="modal">×</a>
										<h3>修改轮播图</h3>
									...
									<div class="modal-body">
										<div id='success'>
											<input type="hidden" name="id" /> <input type="checkbox"
												id='modifyfile' name='modifyfile' checked="checked" />修改图片<br />
											<input type='file' name="imgFile" /><br /> <input
												type="text" hidden="图片描述" name="imgInfo" /><br />
										</div>
										<div id='fail'>
	...
	<script src="/app/js/ajax/homeimg.js"></script>
