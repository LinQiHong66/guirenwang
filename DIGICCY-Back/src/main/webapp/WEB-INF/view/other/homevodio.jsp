...
<body class="fixed-top">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="#">首页视频</a><span class="divider-last">&nbsp;</span></li>
						</ul>
					</div>
				</div>
				<!-- BEGIN PAGE CONTENT-->
					...
					<div class="span12 sortable">
						...
						<div class="widget">
							...
							<div class="widget-body">
								...
								<form action="/other/saveVedio.do" enctype="multipart/form-data" method="POST">
								<input type="file" name="file" /><br />
								<input type="submit" value="更改视频" />
								</form><br />
								<h3>目前视频</h3><br />
								<video controls autoplay name="media" id="vedio" src="" />
	...
	<script src="/app/js/ajax/vedio.js"></script>
