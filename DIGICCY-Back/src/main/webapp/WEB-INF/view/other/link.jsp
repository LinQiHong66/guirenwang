...
<body class="fixed-top">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="#">友情链接</a><span class="divider-last">&nbsp;</span></li>
						</ul>
					</div>
				</div>
				<!-- BEGIN PAGE CONTENT-->
						...
						<div class="widget">
							...
							<div class="widget-body">
							 ...
							 <div id="addmodal" class="modal hide fade in"
								...
								<form action="/other/addLink.do" method="POST">
									<div class="modal-header">
										<a class="close" data-dismiss="modal">×</a>
										<h3>添加友情链接</h3>
									</div>
									<div class="modal-body">
										链接名称：<input type='text' name="linkName" /><br /> 链接地址：<input
											type="text" name="linkUrl" /><br />链接类型：<input
											type="text" name="linkType" />
									</div>
							...
							<div id="modifymodal" class="modal hide fade in"
								...
								<form action="/other/updateLink.do" method="POST">
									<div class="modal-header">
										<a class="close" data-dismiss="modal">×</a>
										<h3>修改链接</h3>
									</div>
									<div class="modal-body">
										<div id='success'>
											...
											链接名<input type='text' name="linkName" /><br />链接url<input
												type="text" name="linkUrl" /><br />
												链接类型<input
												type="text" name="linkType" />
										</div>
									</div>
	...
	<script src="/app/js/ajax/link.js"></script>
