            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">任务列表</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                           ...
                           <a onclick="addRead();"><button class="btn btn-success" id="btn_add" data-toggle="modal" style="margin-bottom: 8px;" data-target="#myModal"><i class="icon-plus icon-white"></i>&nbsp;新增</button></a>
                           <div style="height:500px;">
                            <table id="complete_table" class="table table-hover">
									<thead>
										<tr>
											<th style="width:40%">类型</th>
											<th style="width:30%">积分奖励</th>
											<!--<th>奖励状态</th>  -->
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="" id="submitForm">
				...
				<div class="form-group" align="center">
					<label for="lastname" class="col-sm-2 control-label">积分奖励</label>
					<div class="col-sm-10">
...
<script src="/app/js/bootstrap-table/integral/integral-complete.js"></script>
</body>
<!-- END BODY -->
</html>
