            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">新增帮助中心项目</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>新增帮助中心项目</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            ...
                            <%--<button class="btn btn-primary" id="btn_delete"><i class="icon-remove icon-white"></i>&nbsp;删除</button>--%>
                                <div class="form-group" style="margin-top: 5px">
                                    ...
                                    <input type="text" name="help_name" id="help_name" class="form-control" style="border-radius: 5px">
                                </div>
                                <div class="form-group" style="margin-top: 5px">
                                    <label class="form-label">帮助中心项目等级:</label>&nbsp;&nbsp;
                                    <select class="input-large m-wrap" tabindex="1" id="help_grade" name="help_grade">
                                    	<option value="1" selected="selected">帮助中心一级</option>
                                    	<option value="2">帮助中心二级</option>
                                    </select>
                                </div>
                                
                                <div class="form-group" id="showbox1" style="margin-top: 5px;display:none">
                                    <label class="form-label">帮助中心项目父类:</label>&nbsp;&nbsp;
                                    <select class="input-large m-wrap" id="help_parent" name="help_parent" >
										<option value="">==请选择项目父类==</option>
										<c:forEach items="${helpCenter}" var="helpCenter">
											<option value="${helpCenter.id}">${helpCenter.help_name}</option>
										</c:forEach>
									</select>
                                </div>
                                <div class="form-group" id="showbox2" style="margin-top: 5px;display:none">
                                	<div class="form-group" style="margin-top: 5px">
                            ...
                            <div class="form-group" style="margin-top: 5px">
                                <button id="addHelpCenter" class="btn">提交</button>
...
<script src="/app/js/ajax/helpCenter_add.js"></script>
