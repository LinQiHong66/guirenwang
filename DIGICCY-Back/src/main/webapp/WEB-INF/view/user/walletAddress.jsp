            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="#">钱包信息</a> <span class="divider">&nbsp;</span>
                        </li>
                        <li><a href="#">钱包信息</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>钱包信息</h4>
                            <span class="tools">
...
<script src="/app/js/bootstrap-table/wallet-address-tab.js"></script>
