				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="#">敏感信息修改</a><span class="divider-last">&nbsp;</span></li>
						</ul>
					</div>
				</div>
				<!-- BEGIN PAGE CONTENT-->
								...
								<table id="recharge_table" style="width: 99%">
									<tbody align="center" style="width: 100%">
										<input type="hidden" id="no" class="form-control"
											style="border-radius: 5px" value="${data.user_no}">
										<tr style="width: 100%">
											<td style="text-align: center; width: 50%">用户账号</td>
											<td style="text-align: center; width: 50%"><input
												type="number" id="name" name="name" value="${data.username}"
												oninput="if(value.length>4)value=value.slice(0,11)" /></td>
										</tr>
										<tr style="width: 100%">
											<td style="text-align: center; width: 50%">真实姓名</td>
											<td style="text-align: center; width: 50%"><input
												value="${data.real_name}" type="text" id="realname"
												name="realname" /></td>
										</tr>
										<tr style="width: 100%">
											<td style="text-align: center; width: 50%">身份证</td>
											<td style="text-align: center; width: 50%"><input
												value="${data.certificate_num}" type="text"
												id="certificate_num" name="certificate_num"
												oninput="if(value.length>4)value=value.slice(0,18)" /></td>
										</tr>
										<tr style="width: 100%">
											<td style="text-align: center; width: 50%">银行卡</td>
											<td style="text-align: center; width: 50%"><input
												value="${data.alipay}" type="text" id="alipay" name="alipay" /></td>
										</tr>
										<tr style="width: 100%">
