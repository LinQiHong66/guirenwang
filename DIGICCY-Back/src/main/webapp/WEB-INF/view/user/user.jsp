                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                        	<button class="btn btn-success" >&nbsp;当前总人数:${sumUser}</button>
                        	<button class="btn btn-success" >&nbsp;今日注册人数:${dayUser}</button>
                        	<button class="btn btn-success" >&nbsp;总机构数:${sumUser0}</button>
                        	<button class="btn btn-success" >&nbsp;总子机构数:${sumUser1}</button>
                        	<button class="btn btn-success" >&nbsp;总经济人数:${sumUser2}</button>
                        	<button class="btn btn-success" >&nbsp;总交易商数:${sumUser3}</button>
                        	<button class="btn btn-success" >&nbsp;今日经济人数:${dayUser2}</button>
                        	<button class="btn btn-success" >&nbsp;今日交易商数:${dayUser3}</button><br />
                            ...
                            用户名称或编号<input style="width:12%" type="text" id="names" name='username' />电话号码<input style="width:10%" type='text' id='phone' name='phone' />
                            状态<select style="width:15%" id='state' name='state'>
                            ...
                            <div align='center'>
                            	当前页数：第<span id='curPage'></span>页
                            	&nbsp;&nbsp;
                            	一共<span id='countItem'></span>条数据
                            	&nbsp;&nbsp;
                            	每页<select id='checkItem' onchange="itemChange();">
...
<script>
	...
	function overPage(){
		...
		var countPage = countItem/pageItem;
		if(countItem%pageItem > 0){
			countPage = (countPage/1)+1;
		}
		curPage = (curPage/1)+1;
