...
<div id="container" class="row-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="#">后台参数设置</a> <span class="divider">&nbsp;</span>
                        </li>
                        <li><a href="#">后台参数设置</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>后台参数设置</h4>
                            <span class="tools">
    ...
    <div class="boxK" id="box_add">
        ...
        <form class="form-inline">
            <div class="form-group" style="margin-top: 5px">
                ...
                <input type="text"  id="add_param" class="form-control" style="border-radius: 5px">
            </div>
            <div class="form-group" style="margin-top: 5px">
                <label class="form-label">参数数值:</label>&nbsp;&nbsp;
                <input type="text"  id="add_value" class="form-control" style="border-radius: 5px">
            </div>
            <div class="form-group" style="margin-top: 5px">
                <button type="button" class="btn blue" id="add_Role" onclick="addParam()"><i class="icon-ok"></i> Save</button>
    ...
    <div class="boxK" id="box_update">
        ...
        <form class="form-inline">
            <div class="form-group" style="margin-top: 5px">
                <label class="form-label">参数名称:</label>&nbsp;&nbsp;
                <input type="hidden"  id="param_id" class="form-control" style="border-radius: 5px">
                <input type="text"  id="update_param" class="form-control" style="border-radius: 5px">
            </div>
            <div class="form-group" style="margin-top: 5px">
                <label class="form-label">参数数值:</label>&nbsp;&nbsp;
                <input type="text"  id="update_value" class="form-control" style="border-radius: 5px">
            </div>
            <div class="form-group" style="margin-top: 5px">
                <button type="button" class="btn blue" id="add_Role" onclick="updateParam()"><i class="icon-ok"></i> Save</button>
                <button type="reset" class="btn"><i class=" icon-remove"></i> Cancel</button>
            </div>
        </form>
    </div>
...
<script src="/app/js/ajax/param.js"></script>
...
<script src="/app/js/bootstrap-table/param-tab.js"></script>
