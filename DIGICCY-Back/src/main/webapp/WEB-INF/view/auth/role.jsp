...
<head>
    ...
    <link href="/app/assets/ztree/css/metroStyle/metroStyle.css" rel="stylesheet" />
...
<div id="container" class="row-fluid">
    ...
    <div class="boxK" id="box_add">
        ...
        <form class="form-inline">
            <div class="form-group" style="margin-top: 5px">
                ...
                <input type="text" name="role.name" id="role_name" class="form-control" style="border-radius: 5px">
            </div>
            <div class="form-group" style="margin-top: 5px">
            ...
            <div class="form-group" style="margin-top: 5px">
                <button type="button" class="btn blue" id="add_Role" onclick="addRole()"><i class="icon-ok"></i> Save</button>
    ...
    <!-- 分配权限 -->
    <div class="boxK" id="box_res" style="width: 280px">
        <div class="closeK clearfix"><i class="icon-remove icon-white" id="close_res"></i></div>
        <h4>分配权限</h4><br/><br/>
        <div>
            <input type="hidden" id="role_res">
...
<script src="/app/assets/ztree/js/jquery.ztree.all.js"></script>
<script src="/app/assets/ztree/js/jquery.ztree.core.js"></script>
<script src="/app/assets/ztree/js/jquery.ztree.excheck.js"></script>
<script src="/app/js/ajax/role.js"></script>
...
<script src="/app/js/bootstrap-table/role-tab.js"></script>
