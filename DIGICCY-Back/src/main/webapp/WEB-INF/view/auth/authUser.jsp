...
<div id="container" class="row-fluid">
    ...
    <div class="boxK" id="box_add">
        ...
        <form class="form-inline">
            <div class="form-group" style="margin-top: 5px">
                ...
                <input type="text" name="role.name" id="add_name" class="form-control" style="border-radius: 5px">
            </div>
            <div class="form-group" style="margin-top: 5px">
                <label class="form-label">用户密码:</label>&nbsp;&nbsp;
                <input type="password" name="role.description" id="add_pass" class="form-control" style="border-radius: 5px">
            </div>
            <div class="form-group" style="margin-top: 5px">
                <label class="form-label">用户角色:</label>&nbsp;&nbsp;
                <select  class="input-large m-wrap" tabindex="1" id="add_role">

                </select>
                <%--<input type="text" name="role.description" id="role_desc" class="form-control" style="border-radius: 5px">--%>
            </div>
            <div class="form-group" style="margin-top: 5px">
                <button type="button" class="btn blue" id="add_user" onclick="addUser()"><i class="icon-ok"></i> Save</button>
    ...
    <div class="boxK" id="box_update">
        ...
        <h4>修改角色</h4><br/><br/>
        <form class="form-inline">
            <input type="hidden" name="role.name" id="update_id" class="form-control" style="border-radius: 5px">
            <div class="form-group" style="margin-top: 5px">
                <label class="form-label">用户账号:</label>&nbsp;&nbsp;
            ...
            <div class="form-group" style="margin-top: 5px">
                <label class="form-label">用户密码:</label>&nbsp;&nbsp;
                <input type="password" name="role.description" id="update_pass" class="form-control" style="border-radius: 5px">
            </div>
            <div class="form-group" style="margin-top: 5px">
                <label class="form-label">用户角色:</label>&nbsp;&nbsp;
                <select  class="input-large m-wrap" tabindex="1" id="update_role">

                </select>
                <%--<input type="text" name="role.description" id="role_desc" class="form-control" style="border-radius: 5px">--%>
            </div>
            <div class="form-group" style="margin-top: 5px">
                <button type="button" class="btn blue" id="update_user" onclick="updateUser()"><i class="icon-ok"></i> Save</button>
                <button type="reset" class="btn"><i class=" icon-remove"></i> Cancel</button>
            </div>
        </form>
    </div>
...
<script src="/app/js/ajax/user.js"></script>
...
<script src="/app/js/bootstrap-table/user-tab.js"></script>
