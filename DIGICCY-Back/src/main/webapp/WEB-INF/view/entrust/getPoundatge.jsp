...
<body class="fixed-top">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="#">充值提现管理</a> <span class="divider">&nbsp;</span>
							</li>
					...
					<div class="span12 sortable">
						...
						<div class="widget">
							...
							<div class="widget-body">
								查询条件：<br /> 用户编号：<input type="text" id="userOrgCode" />手机号：<input
									type="text" id="phone" />姓名：<input id="username" type="text" />时间：<input
									type="date" id="startDate" />-<input type="date" id="endDate" />
								<br />
								<button onclick="selectPound()">查询</button>
								<br />
								<table id="poundatge_table">
	...
	<script src="/app/js/bootstrap-table/poundatge_tab.js"></script>
