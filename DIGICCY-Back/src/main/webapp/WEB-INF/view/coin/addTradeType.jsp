            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">新增货币交易类型</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>新增货币交易类型</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            ...
                            <%--<button class="btn btn-primary" id="btn_delete"><i class="icon-remove icon-white"></i>&nbsp;删除</button>--%>
                                ...
                                <div class="form-group" style="margin-top: 5px">
                                    <label class="form-label">兑换货币类型:</label>&nbsp;&nbsp;
                                    <select  class="input-large m-wrap" tabindex="1" id="tran_coin_no">
										<c:forEach items="${coin.data}" var="tranCoin">
											<option value="${tranCoin.coin_no}">${tranCoin.coin_name}</option>
										</c:forEach>
									</select>
                                </div>
                                <div class="form-group" style="margin-top: 5px">
                            ...
                            <div class="form-group" style="margin-top: 5px">
                                <button id="addTradeType"  class="btn">提交</button>
...
<script src="/app/js/ajax/tradeType_add.js"></script>
