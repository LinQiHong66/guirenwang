            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">虚拟货币交易条件信息</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>虚拟货币交易条件信息</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                           <a href="/coinTranAstrict/gotoAdd.do"><button class="btn btn-success" id="btn_add"><i class="icon-plus icon-white"></i>&nbsp;新增</button></a>
                            ...
                            <table id="coinTranAstrict_table">
...
<script src="/app/js/bootstrap-table/coinTranAstrict-tab.js"></script>
