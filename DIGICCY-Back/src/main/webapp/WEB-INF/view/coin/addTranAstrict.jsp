                        ...
                        <div class="widget-body">
                            ...
                            <%--<button class="btn btn-primary" id="btn_delete"><i class="icon-remove icon-white"></i>&nbsp;删除</button>--%>
                                ...
                                <div class="form-group" style="margin-top: 5px">
                                    ...
                                    <input type="text" id="buy_min_price" name="buy_min_price" onblur="isNumber(this)" class="form-control" style="border-radius: 5px">
                                	<span style="color:red">注意：买入最低价必填</span>
                                </div>
                                <div class="form-group" style="margin-top: 5px">
                                    <label class="form-label">买入最高价:</label>&nbsp;&nbsp;
                                    <input type="text" id="buy_max_price" name="buy_max_price" onblur="isNumber(this)" class="form-control" style="border-radius: 5px">
                                	<span style="color:red">注意：买入最高价必填</span>
                                </div>
                                <div class="form-group" style="margin-top: 5px">
                                    <label class="form-label">卖出最低价:</label>&nbsp;&nbsp;
                                    <input type="text" id="sell_min_price" name="sell_min_price" onblur="isNumber(this)" class="form-control" style="border-radius: 5px">
                                	<span style="color:red">注意：卖出最低价必填</span>
                                </div>
                                <div class="form-group" style="margin-top: 5px">
                                    <label class="form-label">卖出最高价:</label>&nbsp;&nbsp;
                                    <input type="text" id="sell_max_price" name="sell_max_price" onblur="isNumber(this)" class="form-control" style="border-radius: 5px">
                                	<span style="color:red">注意：卖出最高价必填</span>
                                </div>
                                <div class="form-group" style="margin-top: 5px">
                                    <label class="form-label">单笔最小交易额:</label>&nbsp;&nbsp;
                                    <input type="text" id="single_min_price" name="single_min_price" onblur="isNumber(this)" class="form-control" style="border-radius: 5px">
                                	<span style="color:red">注意：单笔最小交易额必填</span>
                                </div>
                                <div class="form-group" style="margin-top: 5px">
                                    <label class="form-label">单笔最大交易额:</label>&nbsp;&nbsp;
                                    <input type="text" id="single_max_price" name="single_max_price" onblur="isNumber(this)" class="form-control" style="border-radius: 5px">
                                	<span style="color:red">注意：单笔最大交易额必填</span>
                                </div>
                                <div class="form-group" style="margin-top: 5px">
                                    <label class="form-label">涨幅:</label>&nbsp;&nbsp;
                                    <input type="text" id="rose_astrict" name="rose_astrict" onblur="isNumber(this)" class="form-control" style="border-radius: 5px">
                                	<span style="color:red">%，注意：涨幅必填</span>
                                </div>
                                <div class="form-group" style="margin-top: 5px">
                                    <label class="form-label">跌幅:</label>&nbsp;&nbsp;
                                    <input type="text" id="drop_astrict" name="drop_astrict" onblur="isNumber(this)" class="form-control" style="border-radius: 5px">
                                	<span style="color:red">%，注意：跌幅必填</span>
                                </div>
                                <div class="form-group" style="margin-top: 5px">
                                    <label class="form-label">开始时间:</label>&nbsp;&nbsp;
                                    <input type="text" id="beginDate" name="beginDate" onclick="laydate()" class="laydate-icon" class="form-control" style="border-radius: 5px">
                                </div>
                                <div class="form-group" style="margin-top: 5px">
                            ...
                            <div class="form-group" style="margin-top: 5px">
                                <button id="addTranAstrict"  class="btn">提交</button>
...
<script src="/app/js/ajax/tranAstrict_add.js"></script>
