...
<div id="container" class="row-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">未受理权限申请</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>未受理权限申请</h4>
                            <span class="tools">
    ...
    <div class="boxK" id="box_update">
        ...
        <form class="form-inline">
            ...
            <div class="form-group" style="margin-top: 5px">
                <label class="form-label">货币编号:</label>&nbsp;&nbsp;
                <input type="text"  id="update_no" class="form-control" style="border-radius: 5px">
            </div>
            <div class="form-group" style="margin-top: 5px">
                <label class="form-label">货币名称:</label>&nbsp;&nbsp;
...
<script src="/app/js/bootstrap-table/userlevel-table.js"></script>
</body>
<!-- END BODY -->
</html>