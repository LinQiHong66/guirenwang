            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">话费充值</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>话费充值</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <div>
                                <input type="text" name="recharge_phone" id="recharge_phone" class="form-control">
                                <button class="btn btn-success" id="bill_update" style="margin-top: -10px" onclick="updateBillState();"><i class="icon-search icon-white"></i>&nbsp;充值</button>
                                <table id="bill_update_table">
...
<script src="/app/js/bootstrap-table/bill-tab.js"></script>
</body>
