				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="#">资金异常管理</a> <span class="divider">&nbsp;</span>
							</li>
							<li><a href="#">资金异常列表</a><span class="divider-last">&nbsp;</span></li>
						</ul>
					</div>
				</div>
				<!-- BEGIN PAGE CONTENT-->
					...
					<div class="span12 sortable">
						...
						<div class="widget">
							...
							<div class="widget-body">
								...
								<table id="speculativeFunds_table">
