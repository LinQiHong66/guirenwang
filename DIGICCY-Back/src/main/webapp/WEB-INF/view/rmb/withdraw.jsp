            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">人民币提现</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                </div>
            </div>
            <!-- BEGIN PAGE CONTENT-->
                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>人民币提现</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                        	<button class="btn btn-success" >&nbsp;总出金额:${sumPrice}</button>
                        	<button class="btn btn-success" >&nbsp;今日计划出金额:${dayPrice}</button>
                        	<br>
                            ...
                            <table id="withdraw_table" style='width:100%'>

                            </table>
                            <div id="withD" align="center">
                            	一共<span id='countItemW'></span>条数据，当前第<span id="curPageW"></span>页&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            	每页<select onchange="changeItem()" id="pageItemW" style='width:7%'></select>条
...
<script>
function search(){
	var pageItem = $('#pageItemW').val();
	if(pageItem == null && pageItem == ""){
		pageItem=10;
	}
	selectWithdraw(1, pageItem);
}
function nextPage(){
	var curPage = $('#curPageW').html();
	var pageItem = $('#pageItemW').val();
	var counItem = $('#countItemW').html();
	var counPage = 1;
	...
	selectWithdraw(curPage, pageItem);
}
function overPage() {
	var curPage = $('#curPageW').html();
	var counItem = $('#countItemW').html();
