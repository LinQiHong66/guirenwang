    ...
    $.ajax({
        ...
        success: function (msg) {
            $("#address_table").bootstrapTable({
                ...
                cache:false,
                columns:[[// 列
                    {title:'用户ID',field:'user_no',width:60,align:'center'},
                    {title:'用户姓名',field:'name',width:60,align:'center'},
                    {title:'手机号码',field:'phone',width:60,align:'center'},
                    {title:'居住地省市区',field:'remark_address',width:60,align:'center'},
                    {title:'居住地详细地址',field:'address',width:60,align:'center'},
                    {title:'邮政编码',field:'card',width:60,align:'center'},
                    {title:'日期',field:'date',width:60,align:'center'},
                    {title:'操作',field:'id',width:120,align:'center',
                        formatter : function(value, row, index) {
                            var str = row.user_no+","+row.name+","+row.phone+","+row.remark_address+","+row.address+","+row.card;
                            var e;
