$("#withdraw_table").bootstrapTable({
 ...
 /* contentType : "application/x-www-form-urlencoded",*/
  ...
  columns:[[// 列
	   ...
	   {field: 'coinName',title: '转出币种',align: 'center'},
	   {field: 'addressFrom',title: '转出地址',align: 'center'},
	   {field: 'number',title: '转出数量',align: 'center'},
	   {field: 'poundage',title: '手续费',align: 'center'},
	   {field: 'realNumber',title: '到账数量',align: 'center'},
	   {field: 'date',title: '转出时间',align: 'center'},
