...
public class SubRecordEvent {
    ...
    public SubRecordEvent(Integer user_no, Integer coin_no, String sub_name, BigDecimal sub_price, BigDecimal sub_num, BigDecimal sum_price, Integer thaw_num, Date thaw_time, BigDecimal sur_frozen, Integer state, Date date, BigDecimal thaw_sum) {
