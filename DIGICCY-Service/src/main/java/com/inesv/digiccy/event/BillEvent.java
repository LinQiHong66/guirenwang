...
public class BillEvent {
    ...
    public BillEvent(Integer user_no, String recharge_phone, BigDecimal recharge_price, Integer pay_type, BigDecimal pay_price, Date handle_date, Integer state, Date date,String operation) {
