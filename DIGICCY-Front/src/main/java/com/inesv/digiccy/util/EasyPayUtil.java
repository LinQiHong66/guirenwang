...
private static Logger logger = LoggerFactory.getLogger(EasyPayUtil.class);
	 ...
	 * 支付请求地址
	 */
	private static final String payURL = "http://cashier.etonepay.com/NetPay/BankSelect.action";
	/**
	 * 查询请求地址
	 */
	private static final String queryURL = "http://cashier.etonepay.com/NetPay/MerOrderQuery.action";
	/**
	 * 交易代码
	 */
	 ...
	 * 商户编号
	 */
	private static final String merchantId = "888201705030101";
	/**
	 * 业务代码
	 */
	private static final String bussID = "888102";
	/**
	 * datakey
	 */
	private static final String dataKey = "l28w6mKL726001C8";
	/**
	 * 货币代码
	 */
	 ...
	 * 页面返回地址
	 */
	private static final String merURL = "http://47.92.3.50/rmbRecharge/jishi.d";
	/**
	 * 回调地址
	 */
	private static final String backURL = "http://47.92.3.50/rmbRecharge/yibu.do";
	...
	public static boolean validateReturnInfo(HttpServletRequest request){
		 ...
		 * 构建返回表单并赋值
		 */
		BackForm backForm = buildForm(transCode, merchantId, respCode,
				sysTraceNum, merOrderNum, orderId, bussID, tranAmt, orderAmt,
				bankFeeAmt, integralAmt, vaAmt, bankAmt, bankId, integralSeq,
				vaSeq, bankSeq, tranDateTime, payMentTime, settleDate,
				currencyType, orderInfo, userId, signValue);
		/**
		 * 生成响应
		 */
		String resp = null;
	...
	*/ 
	...
	private static BackForm buildForm(String transCode, String merchantId,
	...
	public static void main(String[] args) throws Exception {
		//System.out.println(pay("201705051232", 1L));
		System.out.println(query("201705051232", "20170825"));
	}
