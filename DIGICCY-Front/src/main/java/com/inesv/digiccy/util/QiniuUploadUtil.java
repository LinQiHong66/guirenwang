...
public class QiniuUploadUtil {
    ...
    private static String accessKey  = PropertiesUtil.getPropertiesValue("frontKey.properties", "accessKey");

    private static String secretKey  = PropertiesUtil.getPropertiesValue("frontKey.properties", "secretKey");

    private static String bucket     = PropertiesUtil.getPropertiesValue("frontKey.properties", "bucket");

    private static String startStaff = PropertiesUtil.getPropertiesValue("frontKey.properties", "startStaff");
