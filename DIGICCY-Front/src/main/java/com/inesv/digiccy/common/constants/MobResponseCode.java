...
import com.inesv.digiccy.common.inout.CommonOut;
...
public class MobResponseCode
{
    ...
    // 状态无效
    public static final String STATUS_INVALID = "121";
    
    public static final String STATUS_INVALID_DESC = "状态无效";
    
    /******************************* 用户 begin ******************************/
    // 手机号码不存在
    public static final String USER_MOBILE_NOT_FOUND = "201";
    
    public static final String USER_MOBILE_NOT_FOUND_DESC = "手机号码不存在";
    
    // 手机号码已经注册
    public static final String USER_MOBILE_REPEAT = "199";
    ...
    // 验证码不正确
    public static final String USER_CAPTCHA_ERROR = "203";
    
    public static final String USER_CAPTCHA_ERROR_DESC = "验证码不正确";
    
    // 验证码已过期
    public static final String USER_CAPTCHA_EXPARIED = "204";
    
    public static final String USER_CAPTCHA_EXPARIED_DESC = "验证码已过期";
    
    // 验证码发太快
    public static final String USER_CAPTCHA_TOOFAST = "205";
    
    public static final String USER_CAPTCHA_TOOFAST_DESC = "验证码发太快";
     
    
    // 用户中心登陆错误
    public static final String USERCENTER_ERROR = "206";
    ...
    // 网络不好
    public static final String NETWORK_NOT_GOOD = "913";
     ...
     * @param response
     */
    public static void success(BaseRes response)
    {
     ...
     * @param response
     */
    public static void sysException(BaseRes response)
    {
     ...
     */
    public static boolean isSuccess(CommonOut out, BaseRes response)
    {
